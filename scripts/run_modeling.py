#!/usr/bin/env python3
"""
AI Job Market Analysis - Modeling Pipeline Script
...
Usage:
    python scripts/run_modeling.py [--regression] [--classification] [--clustering] [--all]
"""
...
from src.models.regression import run_salary_regression
